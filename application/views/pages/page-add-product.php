                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="productAmount" placeholder="Product Amount">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="productDiscType" value="flat" checked>
                                        <label class="form-check-label" for="">Flat</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="productDiscType" value="perce">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="productDiscAmount" placeholder="Product Discount Amount">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Payable Discount Amount</label>
                                <input type="text" class="form-control" name="productPayableAmount" placeholder="Payable Discount Amount" readonly>
                            </div>
                        </div>
                    </div>
